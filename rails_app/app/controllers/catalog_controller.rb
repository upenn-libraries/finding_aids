...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_sort_field 'year-desc', sort: 'years_iim desc, title_tsi asc, score desc',
                                       label: I18n.t('sorts.year_desc')
    config.add_sort_field 'year-asc', sort: 'years_iim asc, title_tsi asc, score desc',
                                      label: I18n.t('sorts.year_asc')
    config.add_sort_field 'title-desc', sort: 'title_tsi desc, score desc', label: I18n.t('sorts.title_desc')
    config.add_sort_field 'title-asc', sort: 'title_tsi asc, score desc', label: I18n.t('sorts.title_asc')
